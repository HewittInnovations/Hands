  ...
  while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
      for hand_landmarks in results.multi_hand_landmarks:
        ...
        f.write("INDEX_Y " + str(landmarks[INDEX_FINGER_TIP].y) + " INDEX_X " + str(landmarks[INDEX_FINGER_TIP].x) +  " INDEX_Z " + str(landmarks[INDEX_FINGER_TIP].z) + 
                " THUMB_Y " + str(landmarks[THUMBS_TIP].y) + " THUMB_X " + str(landmarks[THUMBS_TIP].x) + " THUMB_Z " + str(landmarks[THUMBS_TIP].z) + "\n")
